                            ...
                            <Panel title={`Statistics for "${cardStats.card}"`}>
                                <Row>
                                    <Col>
                                        ...
                                        {cardStats.otherChatMessages &&
                                            cardStats.otherChatMessages.length > 0 && (
                                                <div>
                                                    <p>Other chat messages:</p>
                                                    <ul>
                                                        {cardStats.otherChatMessages.map(
                                                            (msg, index) => (
                                                                <li key={index}>{msg}</li>
                                                            )
                                                        )}
                                        ...
                                        <p>
                                            Win percentage:{' '}
                                            {cardStats.totalGames > 0
                                                ? Math.round(
                                                      (cardStats.winnerPlays /
                                                          cardStats.totalGames) *
                                                          100
                                                  )
                                                : 0}
                                            %
